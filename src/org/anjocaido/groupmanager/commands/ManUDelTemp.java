 ...
 *
 */
public class ManUDelTemp extends BaseCommand {
	...
	protected boolean parseCommand(@NotNull String[] args) {
		...
		if (args.length != 1) {
			sender.sendMessage(ChatColor.RED + Messages.getString("ERROR_REVIEW_ARGUMENTS") + Messages.getString("MANUDELTEMP_SYNTAX")); //$NON-NLS-1$ //$NON-NLS-2$
			return true;
		}
